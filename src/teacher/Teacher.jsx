...
function Teacher() {
            ...
            <div className="flex">
              <div className="grow">
                <div className="flex">
                  ...
                  />
                  <div className="grow">
                    <h4 className="text-lg text-default-800 mb-1 mt-0 font-semibold">Teacher</h4>
  ...
  <div className="container">
    <div className="flex items-center justify-between my-6">
      <div>
        <h4 className="text-base text-default-800">Siswa</h4>
      </div>
    </div>
    ...
    <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 my-3">
        ...
        <div className="p-6">
          <div className="mt-3">
            <h4 className="mt-0 mb-1">
              <a className="text-lg text-default-600 hover:text-primary" href="#">Ilham</a>
            </h4>
            <span className="inline-flex items-center gap-1.5 py-1 px-2 rounded-md text-xs font-semibold bg-primary/10 text-primary">Siswa</span>
          </div>
      ...
      <div className="bg-white rounded border border-gray-300 shadow-lg">
        <div className="p-6">
          <div className="mt-3">
            <h4 className="mt-0 mb-1">
              <a className="text-lg text-default-600 hover:text-primary" href="#">Halima</a>
            </h4>
            <span className="inline-flex items-center gap-1.5 py-1 px-2 rounded-md text-xs font-semibold bg-primary/10 text-primary">siswa</span>
          </div>
      ...
      <div className="bg-white rounded border border-gray-300 shadow-lg">
        <div className="p-6">
          <div className="mt-3">
            <h4 className="mt-0 mb-1">
              <a className="text-lg text-default-600 hover:text-primary" href="#">Farel</a>
            </h4>
            <span className="inline-flex items-center gap-1.5 py-1 px-2 rounded-md text-xs font-semibold bg-primary/10 text-primary">Siswa</span>
          </div>
          <div className="flex -space-x-2 mt-3">
