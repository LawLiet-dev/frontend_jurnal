  ...
  return (
    ...
    <div className='bg-[#fff] text-gray-800 w-full min-h-screen flex flex-col'>
      ...
      <div className=" py-20 px-4 mt-15">
            ...
            <p className="text-lg text-gray-600 mb-15 ml-6">We're a top-notch web design and development team helping business to craft the meaningful
            <span className='block whitespace-pre-line'>and interactive product experiences.</span></p>
            <div className="flex space-x-4 ml-6">
                <a href="#" className="shadow-2xl bg-black opacity-70 text-white px-6 py-3 rounded-md flex items-center space-x-2 hover:bg-amber-700">
      ...
      <section class="py-20 bg-primary/10 relative">
        <div class="container relative">
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-16 ml-0 md:ml-16">
                <div class="bg-white p-6 rounded">
                    <div class="flex gap-5">
                        <div class="">
                            <div class="size-16 bg-primary/10 rounded-md flex items-center justify-center gap-5 w-[64px] h-[64px] bg-blue-100 rounded-lg">
                                {/* <span class="i-solar-home-wifi-angle-bold-duotone size-12 text-primary"></span> */}
                                <img src="/assets/images/icons/compass.png" alt="compass" className='w-[35px] h-[35px] mx-auto my-2'/>
                            </div>
                        </div>

                        <div>
                            <h5 class="mb-2 font-bold">Dukungan Relokasi</h5>
                ...
                <div class="bg-white p-6 rounded">
                    <div class="flex gap-5">
                        <div>
                            <div class="size-16 bg-primary/10 rounded-md flex items-center justify-center gap-5 w-[64px] h-[64px] bg-blue-100 rounded-lg">
                                {/* <i class="i-solar-users-group-two-rounded-bold-duotone size-12 text-primary"></i> */}
                                <img src="/assets/images/icons/layers.png" alt="location-pin" className='w-[35px] h-[35px] mx-auto my-2'/>
                            </div>
                        </div>
                        <div>
                            <h5 class="mb-2 font-bold">Technology</h5>
                ...
                <div class="bg-white p-6 rounded">
                    <div class="flex gap-5">
                        <div>
                            <div class="size-16 bg-primary/10 rounded-md flex items-center justify-center gap-5 w-[64px] h-[64px] bg-blue-100 rounded-lg">
                                {/* <i class="i-solar-armchair-2-bold-duotone size-12 text-primary"></i> */}
                                <img src="/assets/images/icons/location-pin.png" alt="layers" className='w-[35px] h-[35px] mx-auto my-2'/>
                            </div>
                        </div>

                        <div>
                            <h5 class="mb-2 font-bold">Beraktivitas dari mana saja</h5>
                ...
                <div class="bg-white p-6 rounded">
                    <div class="flex gap-5">
                        <div>
                            <div class="size-16 bg-primary/10 rounded-md flex items-center justify-center gap-5 w-[64px] h-[64px] bg-blue-100 rounded-lg">
                                {/* <i class="i-solar-sofa-2-bold-duotone size-12 text-primary"></i> */}
                                <img src="/assets/images/icons/team.png" alt="team work" className='w-[35px] h-[35px] mx-auto my-2' />
                            </div>
                        </div>

                        <div>
                            <h5 class="mb-2 font-bold">Kinerja Tim</h5>
    ...
    <div class="flex items-center justify-center mb-30 mt-10 px-4 sm:px-6">
        {/* <!-- Wrapper Layout --> */}
        <div class="flex flex-col gap-6 lg:flex-row lg:gap-12">
          {/* <!-- Card 1 --> */}
          <div class="bg-white border border-gray-200 rounded-lg p-6 h-60 shadow-md w-full lg:w-1/2 transform transition-transform duration-300 ease-out hover:scale-105">
            ...
            <button class="bg-white border border-blue-500 text-blue-500 py-2 px-4 rounded hover:bg-blue-500 hover:text-white">
              Contact Us
            </button>
          </div>
          {/* <!-- Card 2 --> */}
          <div class="bg-white border border-gray-200 rounded-lg p-6 h-60 shadow-md w-full lg:w-1/2 transform transition-transform duration-300 ease-out hover:scale-105">
            <h3 class="text-lg font-semibold mb-4">Pertanyaan</h3>
            <p class="text-gray-600 mb-6">
