 ...
 <div className="bg-gray-100">
  <header className="bg-white shadow-sm">
   <div className="container mx-auto flex justify-between items-center py-4 px-6">
    ...
    <div className="flex items-center space-x-4 px-15">
     <a href="list"><i className="fas fa-clipboard-list text-gray-500 mr-2"></i></a>
  ...
  <nav className="bg-white shadow-sm px-15">
   <div className="container mx-auto flex space-x-4 py-2 px-6">
    <a href="student" className='text-gray-600 px-4 py-2 hover:shadow-lg hover:bg-blue-500 hover:z-100 hover:text-white hover:rounded-lg'>Dashboard</a>
    <a href="jurnal" className='text-gray-600 px-4 py-2 hover:shadow-lg hover:bg-blue-500 hover:z-100 hover:text-white hover:rounded-lg'>Jurnal</a>
   </div>
  </nav>
 </div>
